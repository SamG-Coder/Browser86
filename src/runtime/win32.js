...
import {installShellFolders} from './shell-folders.js';
import {installBufferedPaint} from './buffered-paint.js';
import {installLocaleInfo} from './locale-info.js';
...
import {installCharacterTypes} from './character-type.js';
import {installCommandLineParsing} from './command-line.js';
import {mulDiv} from './integer-math.js';
const INVALID=0xFFFFFFFF;
const SYSTEM=new Set(['kernel32.dll','kernelbase.dll','user32.dll','gdi32.dll','gdiplus.dll','uxtheme.dll','advapi32.dll','msvcrt.dll','ucrtbase.dll','vcruntime140.dll','ntdll.dll','shell32.dll','shlwapi.dll','winmm.dll','comdlg32.dll','comctl32.dll','ole32.dll','oleaut32.dll','version.dll','ws2_32.dll']);
export class Win32 {
  constructor(process){this.p=process;this.m=process.memory;this.vfs=process.vfs;this.functions=new Map();this.traps=new Map();this.nextTrap=0xF0000000;this.moduleHandles=new Map();this.missingMap=new Map();this.allocations=new Map();this.resources=new Map();this.installKernel();this.gui=new GUI(this);installCRT(this);installGDIPlus(this);installShellFolders(this);installBufferedPaint(this);this.installRegistry();}
  ...
  installKernel(){const p=this.p,m=this.m,v=this.vfs;const k=(name,n,fn)=>this.add('kernel32.dll',name,n,fn);
    ...
    installCharacterTypes(this);
    installCommandLineParsing(this);
    k('MulDiv',3,mulDiv);
