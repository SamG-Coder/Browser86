...
void mainCRTStartup(void){
  ...
  {HWND check=CreateWindowExA(0,"BUTTON","Check",0x40000005,0,0,20,20,encodingWindow,(HANDLE)88,0,0);CHECK(check);CHECK(CheckDlgButton(encodingWindow,88,2));CHECK(IsDlgButtonChecked(encodingWindow,88)==2);CHECK(CheckDlgButton(encodingWindow,88,99));CHECK(IsDlgButtonChecked(encodingWindow,88)==2);SetWindowLongA(check,-16,0x40000006);CHECK(SendMessageA(check,0xf5,0,0)==0);CHECK(IsDlgButtonChecked(encodingWindow,88)==0);CHECK(SendMessageW(check,0xf5,0,0)==0);CHECK(IsDlgButtonChecked(encodingWindow,88)==1);CHECK(CheckRadioButton(encodingWindow,88,88,99));CHECK(IsDlgButtonChecked(encodingWindow,88)==0);CHECK(CheckRadioButton(encodingWindow,88,88,88));CHECK(IsDlgButtonChecked(encodingWindow,88)==1);CHECK(DestroyWindow(check));}
