...
API int WINAPI GetClassNameA(HWND,char*,int);
API int WINAPI GetClassNameW(HWND,WORD*,int);
API WORD WINAPI GetWindowWord(HWND,int);
API WORD WINAPI SetWindowWord(HWND,int,WORD);
API WORD WINAPI GetClassWord(HWND,int);
API WORD WINAPI SetClassWord(HWND,int,WORD);
...
typedef struct {DWORD size;WNDCLASSA cls;HANDLE smallIcon;} WNDCLASSEXA;
typedef struct {DWORD size;WNDCLASSW cls;HANDLE smallIcon;} WNDCLASSEXW;
API WORD WINAPI RegisterClassExA(const WNDCLASSEXA*);
API WORD WINAPI RegisterClassExW(const WNDCLASSEXW*);
