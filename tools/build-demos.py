...
U.update({'GetParent':1,'IsChild':2,'IsWindow':1,'GetClientRect':2,'GetWindowRect':2,'ClientToScreen':2,'ScreenToClient':2,'MapWindowPoints':4,'InvertRect':2,'GetSysColor':1,'GetSysColorBrush':1})
