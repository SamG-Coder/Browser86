...
G.update({'GetClipBox':2,'PtVisible':3,'RectVisible':2,'SelectClipRgn':2,'GetClipRgn':2,'InvertRgn':2,'FrameRgn':5,'FillRgn':3,'PaintRgn':2,'GetRegionData':3,'RectInRegion':2,'CreateRectRgn':4,'CreateRectRgnIndirect':1,'SetRectRgn':5,'GetRgnBox':2,'PtInRegion':3,'EqualRgn':2,'OffsetRgn':3})
