...
K.update({'GetCurrentThreadId':0,'GetCurrentProcessId':0,'GlobalAddAtomExA':2,'GlobalAddAtomExW':2,'GlobalAddAtomA':1,'GlobalAddAtomW':1,'GlobalFindAtomA':1,'GlobalFindAtomW':1,'GlobalDeleteAtom':1,'GlobalGetAtomNameA':3,'GlobalGetAtomNameW':3,'InitAtomTable':1,'AddAtomA':1,'AddAtomW':1,'FindAtomA':1,'FindAtomW':1,'DeleteAtom':1,'GetAtomNameA':3,'GetAtomNameW':3})
...
for suffix in ['A','W']:
    for name,count in [('OpenEvent',3),('OpenMutex',3),('OpenSemaphore',3),('CreateEventEx',4),('CreateMutexEx',4),('CreateSemaphoreEx',6)]:
        K[name+suffix]=count
U={'CheckRadioButton':4,'CheckDlgButton':3,'IsDlgButtonChecked':2,'GetDlgItemInt':4,'SetDlgItemInt':4,'SetDlgItemTextA':3,'SetDlgItemTextW':3,'GetDlgItemTextA':4,'GetDlgItemTextW':4,'SendDlgItemMessageA':5,'SendDlgItemMessageW':5,'GetClassNameA':3,'GetClassNameW':3,'GetWindowWord':2,'SetWindowWord':3,'GetClassWord':2,'SetClassWord':3,'GetDoubleClickTime':0,'SetDoubleClickTime':1,'SetCapture':1,'GetCapture':0,'ReleaseCapture':0,'ShowCursor':1,'LoadCursorA':2,'LoadCursorW':2,'SetCursor':1,'GetCursor':0,'DestroyCursor':1,'RegisterClassExA':1,'RegisterClassExW':1,'GetWindowLongA':2,'GetWindowLongW':2,'SetWindowLongA':3,'SetWindowLongW':3,'SetClassLongA':3,'SetClassLongW':3,'GetClassLongA':2,'GetClassLongW':2,'UnregisterClassA':2,'UnregisterClassW':2,'GetWindowTextLengthA':1,'GetWindowTextLengthW':1,'GetWindowTextA':3,'GetWindowTextW':3,'SetWindowTextW':2,'SendMessageA':4,'SendMessageW':4,'RegisterClassW':1,'CreateWindowExW':12,'FrameRect':3,'RegisterClassA':1,'CreateWindowExA':12,'ShowWindow':2,'UpdateWindow':1,'GetMessageA':4,'TranslateMessage':1,'DispatchMessageA':1,'DefWindowProcA':4,'PostQuitMessage':1,'DestroyWindow':1,'BeginPaint':2,'EndPaint':2,'SetWindowTextA':2,'MessageBoxA':4,'InvalidateRect':3,'SetTimer':4,'KillTimer':2,'FillRect':3}
...
U.update({'IsWindowUnicode':1,'GetWindowThreadProcessId':2,'EnumPropsA':2,'EnumPropsW':2,'EnumPropsExA':3,'EnumPropsExW':3,'SetPropA':3,'SetPropW':3,'GetPropA':2,'GetPropW':2,'RemovePropA':2,'RemovePropW':2,'SetFocus':1,'GetFocus':0,'EnableWindow':2,'IsWindowEnabled':1,'IsWindowVisible':1,'GetParent':1,'IsChild':2,'IsWindow':1,'GetClientRect':2,'GetWindowRect':2,'ClientToScreen':2,'ScreenToClient':2,'MapWindowPoints':4,'InvertRect':2,'GetSysColor':1,'GetSysColorBrush':1})
